...
class AIController:
    # Prompt templates
    TITLE_PROMPT_TEMPLATE = Config.Prompts.TITLE_PROMPT_TEMPLATE
    ...
    def get_response(self, conv_id: str, prompt: str, streaming: bool = False) -> str:
        try:
            ...
            return Config.Prompts.ERROR_API_RESPONSE_TEMPLATE.format(error=e)
        except Exception as e:
            # Handle other potential errors
            print(f"An unexpected error occurred: {e}")
            return Config.Prompts.ERROR_UNEXPECTED_RESPONSE_TEMPLATE.format(error=e)
