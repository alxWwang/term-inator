...
class Config:
    ...
    CONVERSATION_HISTORY_PATH = os.path.join(BASE_DATA_PATH, 'conversation_history.json')
    ...
    CONVERSATION_HISTORY_RESOURCE = ("terminator.user.data", "conversation_history.json")
